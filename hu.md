...
> 
> 🐺 Várjunk, miért dobog a szívünk? Miért nem tudunk lélegezni?! Nem úgy van hogy a családban fut a szívroham??!?! Jaj nekem, ez lenne a vég?!?!?!
> 
> 🐺 ÁÁÁÁÁÁÁÁÁÁÁÁÁÁ

4 mentális lépés alatt, egy nem megérkező busz miatt 100%-ig *azt hittem* hogy meg fogok halni.

Szóval, ezért nem bíztam soha a mondásban, hogy "bízz a megérzéseidben." Vagy, hogy "az érzelmeid érvényesek." Képzeld el ezt a szituációt:

> Barát, mondja neked: Értéktelennek érzem magamat. Úgy érzem hogy csak egy teher vagyok mindenki számára. Úgy érzem, hogy mélyen, én egy visszafordíthatatlanul törött, gonosz ember vagyok.

> Te, mondod a barátodnak: Az érzelmeid érvényesek! :D

Ezért, én elhittem azokat a *más* mondásokat: "Az érzelmek irracionálisak." "Az egyetlen dolog amitől félni kell az maga a félelem." "Ne aggódj, légy boldog!"
...
(VICCES TÉNY: 1994-ben, idegtudósok találtak [egy nőt akinek mindkét amigdalája meg volt semmisülve](https://en.wikipedia.org/wiki/S.M._(patient)). Ő volt a nő akinek nem volt félelme. Nem volt aggodalma. Egyáltalán semmi aggodalom. Ezért esett áldozatul, ezért lett kirabolva, és ezért lett majdnem megölve több alkalommal.)
...
Utána, kipróbáltam egy [éberség](https://en.wikipedia.org/wiki/Mindfulness)-alapú terápiát – pontosabban, [Elfogadás & Elköteleződés terápia](https://en.wikipedia.org/wiki/Acceptance_and_commitment_therapy) – ami azt ajánlja hogy *ne* harcolj a gondolataiddal, hanem csak engedd hogy az érzelmek elhaladjanak melletted. (Metafóra amit mondtak nekem: az aggodalom olyan mint a futóhomok – minél többet küzködsz, annál gyorsabban süllyedsz. Ezért: ne küzködj.)

Megintcsak, úgy használtam az éberséget mintha csak egy másik mód lenne arra, hogy *ne figyeljek oda* a félelmemre. A félelem még *mindig* az ellenségem volt.

Egy *évtizedbe* telt míg végre kitaláltam, de a félelem a––

Pillanat, a farkasom mondani akar valamit:

> 🐺 Nicky, a CBT és az éberség *milliónyi* emberen segített, és ez *több száz* tanulmánnyal van alátámasztva. Kik vagyunk *mi* hogy így beszéljünk olyan dolgokról, amik emberek *életét* mentik meg?!

Köszi, farkas! Ez egy nagyon jó aggodalom amit felhoztál.

Szeretném tisztázni: a CBT és az éberség *igenis* segít embereken. *Engem* is nagyon megsegített.

De semmilyen technika nem fog teljesen működni hogy ha azt hiszed hogy a félelem egy *ellenség* amit "le kell győzni" vagy "meg kell hódítani". Vagy egy idegesítő dolog amit "éberséggel" kell elviselni. Ahogy az előbb említettem: egy évtizedbe telt míg végül kitaláltam, de a félelem nem egy ellenség.
...
* Egy aggódó ember vizet önt a zsírtűzre és rosszabbá teszi a helyzetet. Vagy befogják a fülüket hogy ne hallják a riasztót. Vagy összetörik a riasztót egy kalapáccsal. Vagy próbál racionálisan veszekedni a riasztóval a torzulásairól. Vagy úgy dönt hogy "tudatosan" nem figyel oda rá.
...
Igen, elég klisé ennél a pontnál, de meta analízisek kimutatták, hogy a meditáció [javítja az aggodalmat & depressziót](https://jamanetwork.com/journals/jamainternalmedicine/article-abstract/1809754).
...
Annak ellenére hogy az "éberséget" bíráltam az előbb (vagy annak hibás végrehajtását), a meditáció *igenis* alaposan megsegít az életemben.
...
És működik. Mint ahogy a UC Berkeley’s Center for Human Sleep Science igazgatója elmagyarázza [a könyvében](https://www.indiebound.org/book/9781501144318), egy jó esti alvás csökkenti a szívbetegség, rák, Alzheimer's, depresszió, aggodalom, és sok más dolog esélyét. Mint ahogy azt a best-selling gyermekkönyv író egyszer mondta, “[Húzz a francba aludni.](https://www.indiebound.org/book/9781617750250).”
...
A bélbaktériumaid termelik a tested szerotoninjának 90%-át. Szóval: boldogan tartod a mikrobáidat, és ők boldogan tartanak téged, capiche? (Lásd: ennek a [Mentális Egészségügyi Alapítvának a jelentését](https://www.mentalhealth.org.uk/publications/feeding-minds))
...
Amikor elkezdtem írni a játékomat, a *Kalandok Aggodalommal*-t, azt terveztem hogy egy csomó CBT & éberség lecke lesz egy elbeszélésbe csomagolva. Két probléma: 1) a történet nem érződött autentikusnak. 2) Nem tudtam az Aggodalom karakterének a párbeszédét úgy megcsinálni, hogy természetes legyen.

De utána rájöttem a #2 problémának egy egyértelmű megoldására: nem *nekem* kéne az Aggodalom karaktert írnom, hanem az *aggodalmam*nak kéne írnia.

És így kezdődött el egy fura együttműködés.

Érdekes mellékhatás: elkezdtem *kedvelni* az aggodalmamat. Mert most, amikor az aggodalmam egy gondolatspirálba kezdett mint:
...
Ez megoldotta az #1 problémát is: azért érződött kényszerítettnek a történet mert nem adtam az Aggodalom karakternek igazi motívációt. Csak egy Skeletor szerű "gonosz mert gonosz" ellenség volt. De amikor *megkérdeztem* az aggodalmamat hogy mi volt a motívációja, ezt mondta nekem:

> 🐺 Csak azt szeretném, ha biztonságban lennél.

És ezzel a központi motívációval, a *Kalandok Aggodalommal* alapvetően megírta saját magát. Ráadásul, rájöttem hogy miért nem működött nálam a CBT & az éberség: mert még mindig úgy gondoltam hogy a félelem az ellenségem.
...
Ez az esszé a "kiegészítője" az interaktív sztorimnak/játékomnak, [Kalandok Aggodalommal](https://ncase.me/anxiety). Ha szeretnél segíteni hogy még több ingyenes és oktató szavakat+játékokat csináljak, megdobhatsz néhány érmével [Patreonon](https://www.patreon.com/ncase)!
